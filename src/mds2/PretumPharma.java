...
public class PretumPharma extends JFrame{
    ...
    label2.setBounds(85,700,390,40);
     ...
     public class HandlerClass implements ActionListener{
         ...
         public void actionPerformed(ActionEvent event)
        {
            ...
            {
                String s1=JOptionPane.showInputDialog("Celiprolol ,price per piece 12tk\nHow much do you want ??");
            ...
            {
               String s1=JOptionPane.showInputDialog("Labetalol ,price per piece 12tk\nHow much do you want ??");
            ...
            {
                String s1=JOptionPane.showInputDialog(" Metoprolol ,price per piece 12tk\nHow much do you want ??");
            ...
            {
          String s1=JOptionPane.showInputDialog("Nebivolol ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m4+" piece added ");
            ...
            {
           String s1=JOptionPane.showInputDialog("Propranolol ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m5+" piece added ");
            ...
            {
        String s1=JOptionPane.showInputDialog("Chlorthalidone ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m6+" piece added ");
            ...
            {
         String s1=JOptionPane.showInputDialog(" Hydrochloroth ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m7+" piece added ");
            ...
            {
           String s1=JOptionPane.showInputDialog("Indapamide ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m8+" piece added ");
            ...
            {
            String s1=JOptionPane.showInputDialog("Mannitol ,price per piece 12tk\nHow much do you want ??");
