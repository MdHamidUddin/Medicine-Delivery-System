...
public class LifeshavePharma extends JFrame{
    ...
    jpanel.add(image); 
     ...
     public class HandlerClass implements ActionListener{
         ...
         public void actionPerformed(ActionEvent event)
        {
            ...
            {
                 String s1=JOptionPane.showInputDialog(" A-Mycin ,price per piece 12tk\nHow much do you want ??");
            ...
            {
             String s1=JOptionPane.showInputDialog("Ancor ,price per piece 3tk\nHow much do you want ??");
            ...
            {
              String s1=JOptionPane.showInputDialog("Gluvan ,price per piece 11tk\nHow much do you want ??");
            ...
            {
         String s1=JOptionPane.showInputDialog("Ibandron ,price per piece 15tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m4+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Calbon,price per piece 15tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m5+" piece added ");
            ...
            {
         String s1=JOptionPane.showInputDialog("Clinex,price per piece 15tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m6+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Montril,price per piece 15tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m7+" piece added ");
            ...
            {
        String s1=JOptionPane.showInputDialog("Neso ,price per piece 15tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m8+" piece added ");
            ...
            {
           String s1=JOptionPane.showInputDialog("Napro ,price per piece 15tk\nHow much do you want ??");
