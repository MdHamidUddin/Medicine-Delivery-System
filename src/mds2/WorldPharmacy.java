...
public class WorldPharmacy extends JFrame{
   ...
   String list="";
    ...
    public WorldPharmacy()
   {
       super("World Pharmacy ");
 ...
 if(m1>0)
     ...
     public class HandlerClass implements ActionListener{
         ...
         public void actionPerformed(ActionEvent event)
        {
            ...
            {
                String s1=JOptionPane.showInputDialog("Fexo,price per piece 2.5 tk\nHow much do you want ??");
            ...
            {
              String s1=JOptionPane.showInputDialog("Napa ,price per piece 1.2 tk\nHow much do you want ??");
            ...
            {
             String s1=JOptionPane.showInputDialog("\"Pantonix ,price per piece 3 tk\nHow much do you want ??");
            ...
            {
        String s1=JOptionPane.showInputDialog("Sergel ,price per piece 3 tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m5+" piece added ");
            ...
            {
         String s1=JOptionPane.showInputDialog("OffCof ,price per piece 3 tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m6+" piece added ");
            ...
            {
           String s1=JOptionPane.showInputDialog("Pentadol 50 ,price per piece 3 tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m7+" piece added ");
            ...
            {
      String s1=JOptionPane.showInputDialog("Xetril 2 ,price per piece 3 tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m8+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Esloric ,price per piece 3 tk\nHow much do you want ??");
