...
public class BestCarePharma extends JFrame{
    ...
    jpanel.add(image);
     ...
     public class HandlerClass implements ActionListener{
         ...
         public void actionPerformed(ActionEvent event)
        {
            ...
            {
                String s1=JOptionPane.showInputDialog("Glucose ,per Packet price 90 tk\nHow much do you want ??");
            ...
            {
             String s1=JOptionPane.showInputDialog("Amoxicillin ,price per piece 15tk\nHow much do you want ??");
            ...
            {
              String s1=JOptionPane.showInputDialog("Ampicillin  ,price per piece 10tk\nHow much do you want ??");
            ...
            {
         String s1=JOptionPane.showInputDialog("Bleomycin  ,price per piece 17tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m4+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Dapsone ,price per piece 13tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m5+" piece added ");
            ...
            {
         String s1=JOptionPane.showInputDialog("Naloxone ,price per piece 10tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m6+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Ritonavir  ,price per piece 11tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m7+" piece added ");
            ...
            {
       String s1=JOptionPane.showInputDialog("Thiamine,price per piece 18tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m8+" piece added ");
            ...
            {
           String s1=JOptionPane.showInputDialog("Senna ,price per piece 12tk\nHow much do you want ??");
