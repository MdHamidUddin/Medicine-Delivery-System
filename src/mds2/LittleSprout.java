...
public class LittleSprout extends JFrame{
    ...
    jpanel.add(image);
     ...
     public class HandlerClass implements ActionListener{
         ...
         public void actionPerformed(ActionEvent event)
        {
            ...
            {
                 String s1=JOptionPane.showInputDialog(" Morphine ,price per piece 12tk\nHow much do you want ??");
            ...
            {
              String s1=JOptionPane.showInputDialog(" Nalbuphine ,price per piece 12tk\nHow much do you want ??");
            ...
            {
               String s1=JOptionPane.showInputDialog("Paracetamol ,price per piece 12tk\nHow much do you want ??");
            ...
            {
         String s1=JOptionPane.showInputDialog("Pethidine ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m4+" piece added ");
            ...
            {
         String s1=JOptionPane.showInputDialog(" Tramadol ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m5+" piece added ");
            ...
            {
         String s1=JOptionPane.showInputDialog("Capsaicin ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m6+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Camphor ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m7+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Nefopam,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m8+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog(" Aspirin 300mg ,price per piece 12tk\nHow much do you want ??");
