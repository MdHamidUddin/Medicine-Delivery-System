 ...
 * @author Lenovo
 */
public class NusratPharma extends JFrame{
   ...
   String list="";
    ...
    label2.setBounds(85,700,390,40);
       ...
       btn2.setForeground(Color.BLACK);
        ...
        btn3=new JButton("Nalidixic acid");
     ...
     public class HandlerClass implements ActionListener{
         ...
         public void actionPerformed(ActionEvent event)
        {
            ...
            {
                String s1=JOptionPane.showInputDialog("Pizotifen ,price per piece 12tk\nHow much do you want ??");
            ...
            {
              String s1=JOptionPane.showInputDialog(" Ancor ,price per piece 12tk\nHow much do you want ??");
            ...
            {
                String s1=JOptionPane.showInputDialog("Nalidixic acid,price per piece 12tk\nHow much do you want ??");
            ...
            {
         String s1=JOptionPane.showInputDialog("Nitrofurantoin ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m4+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Glycine ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m5+" piece added ");
            ...
            {
         String s1=JOptionPane.showInputDialog("Clinex ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m6+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Montril ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m7+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Niso ,price per piece 12tk\nHow much do you want ??");
