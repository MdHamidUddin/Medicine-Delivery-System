 ...
 * @author Lenovo
 */
public class AfendiPharma extends JFrame {
    ...
    label2.setBounds(85,700,390,40);
     ...
     public class HandlerClass implements ActionListener{
         ...
         public void actionPerformed(ActionEvent event)
        {
            ...
            {
                String s1=JOptionPane.showInputDialog("Captopril ,price per piece 12tk\nHow much do you want ??");
            ...
            {
               String s1=JOptionPane.showInputDialog("Enalapril ,price per piece 12tk\nHow much do you want ??");
            ...
            {
                String s1=JOptionPane.showInputDialog("Fosinopril ,price per piece 12tk\nHow much do you want ??");
            ...
            {
          String s1=JOptionPane.showInputDialog("Lisinopril ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m4+" piece added ");
            ...
            {
           String s1=JOptionPane.showInputDialog("Perindopril ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m5+" piece added ");
            ...
            {
         String s1=JOptionPane.showInputDialog("Ramipril ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m6+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Atenolol ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m7+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Bisoprolol ,price per piece 12tk\nHow much do you want ??");
        ...
        JOptionPane.showMessageDialog(null,+m8+" piece added ");
            ...
            {
          String s1=JOptionPane.showInputDialog("Napro ,price per piece 12tk\nHow much do you want ??");
